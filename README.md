...
[![version](https://img.shields.io/badge/release-0.2.0-success)](https://deno.land/x/oauth2_server@0.2.0)
[![deno doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/oauth2_server@0.2.0/mod.ts)
...
import { OAuth2Server } from "https://deno.land/x/oauth2_server@0.2.0/mod.ts";
// Import from GitHub
import { OAuth2Server } "https://raw.githubusercontent.com/udibo/oauth2_server/0.2.0/mod.ts";
```
...
See
[deno docs](https://doc.deno.land/https/deno.land/x/oauth2_server@0.2.0/mod.ts)
